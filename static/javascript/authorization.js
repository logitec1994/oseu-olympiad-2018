...
class CAuthorization
{
    constructor()
    {
        ...
        this.mStatuses = {
            ...
            "error/registration": "Ошибка, сервера при регистрации.",
            "error/exists": "Ошибка, эта электронная почта уже используется.",
            "error/fields": "Ошибка, не все поля заполнены правильно.",
            "error/login": "Ошибка, неправильный логин или пароль.",
            // "ok/login": ""
        };
    }
